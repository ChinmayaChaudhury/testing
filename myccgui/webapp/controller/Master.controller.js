sap.ui.define([
	...
	return BaseController.extend("com.sap.myccgui.controller.Master", {
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("ID", FilterOperator.EQ, sQuery)];
			} else {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.sap.myccgui.view.ViewSettingsDialog",
					controller: this
